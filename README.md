...
|----------|-----------------|
| Android | [Google Play](https://play.google.com/store/apps/details?id=com.mitossoftwaresolutions.morsecomms) · [GitHub Releases](https://github.com/mitos-software-solutions/morse_comms/releases) (APK) |
